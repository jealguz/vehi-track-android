 ...
 * Permite la exportación de datos desde Firebase Firestore a documentos PDF profesionales,
 * facilitando el archivo físico y la contabilidad de gastos del usuario.
 */
public class ReportesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. INTEGRACIÓN CON ARQUITECTURA BASE
        ...
        // 3. ASIGNACIÓN DE EVENTOS DE GENERACIÓN
    ...
    /**
     * Motor de Consulta para Reportes:
     * Recupera la información de la colección especificada filtrada por el usuario actual.
     */
    private void generarReporte(String coleccion, String nombreArchivo) {
        ...
        db.collection(coleccion)
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    // Inicia el proceso de maquetación del PDF
    ...
    /**
     * Maquetación Gráfica del Documento PDF:
     * Utiliza la API de PdfDocument y Canvas para renderizar tablas y encabezados.
     */
    private void crearPDF(com.google.firebase.firestore.QuerySnapshot datos, String nombreDoc, String tituloReporte) {
        PdfDocument document = new PdfDocument();
        // Configuración de página tamaño A4 (595x842 puntos)
        ...
        paint.setColor(Color.parseColor("#0A2351")); // Azul corporativo Vehi-Track
        canvas.drawRect(0, 0, 595, 90, paint);

        // Renderizado de Identidad Visual (Logo y Eslógan)
        ...
        int y = 190; // Coordenada vertical inicial
        paint.setColor(Color.BLACK);
        ...
        y += 10;
        canvas.drawLine(30, y, 565, y, paint); // Línea divisoria de encabezado
        y += 25;

        // ITERACIÓN Y RENDERIZADO DE REGISTROS
        paint.setFakeBoldText(false);
        for (QueryDocumentSnapshot doc : datos) {
            ...
            // Tratamiento de fechas según el tipo de registro
            String fecha = "N/A";
            ...
            // Normalización de valores monetarios para evitar errores de casteo
            double costoVal = 0;
            ...
            canvas.drawLine(30, y-10, 565, y-10, paint); // Divisor de fila
            paint.setColor(Color.BLACK);
